...
function Hit({
	...
	return (
		<div className='p-4 mb-2 hover:bg-secondary '>
			<Link
				href={`/2008_all_states/${hit.objectID}?id=${hit.objectID}&productID=${hit.id}&price=${hit.price}&title=${hit.title}&type=${hit.productType}&image=${hit.variantImages[0]}&variantID=${hit.objectID}`}
			>
